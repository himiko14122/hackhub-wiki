...
If you are brand new to the toolkit, start by reading the broader [HackHub tools guide for new players](/en/tools/HackHub-Beginner-Toolkit/) to see where netcat sits in the wider loadout philosophy before diving into the command-level details below.
