...
For a broader look at how these tiers fit into the wider economy, our [HackHub contract progression guide](/en/password-hacking/) maps tier progression to early-game credit flow and explains which contracts to accept when you are still running CPU-only hardware.
