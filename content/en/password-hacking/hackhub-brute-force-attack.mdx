...
For new players still learning how each tool fits into the broader progression loop, the [HackHub beginner hacking guide](/en/password-hacking/) is a solid primer that explains how intel gathering feeds into attack selection. The short version: scan with a dictionary probe first, and only escalate to hydra when the probe comes back dry.
