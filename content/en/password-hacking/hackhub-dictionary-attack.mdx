...
If you want a side-by-side comparison with related password methods, our breakdown of the [HackHub brute-force approach](/en/password-hacking/) covers the trade-offs in more depth. For an even broader look at the toolkit, the [HackHub password-hacking hub](/en/password-hacking/) indexes every related contract guide.
...
If you want a deeper dive into the broader contract economy, the [HackHub beginner roadmap](/en/password-hacking/) maps out how dictionary attacks fit into the first ten hours of progression. Otherwise, drop your toughest wordlist questions into the next section.
