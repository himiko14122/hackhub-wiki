...
Für einen tieferen Einblick in Passwort-Wiederverwendungstechniken über Protokolle hinweg, schau dir unseren [HackHub Brute-Force-Angriffe-Leitfaden](/en/password-hacking/) an — er behandelt das Cross-Protokoll-Playbook im Detail.
...
Für Spieler, die noch weiter in das offensive Toolkit vordringen wollen, behandelt unser [HackHub Leitfaden für fortgeschrittene Hacking-Techniken](/en/password-hacking/) Post-Exploitation-Pivots, die auf einem erfolgreichen SSH-Fuß fassen aufbauen.
