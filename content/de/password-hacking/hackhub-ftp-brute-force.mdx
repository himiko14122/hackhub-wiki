...
Spieler, die ihr Kern-Toolkit aufrüsten möchten, beginnen oft mit dem [HackHub Passwort-Cracking](/en/password-hacking/HackHub-password-cracking-basics/) Grundlagenleitfaden, der durch die Engine-Auswahl vor jedem FTP-Lauf führt. Deine Hardware zuerst aufzustellen verhindert den häufigsten Anfängerfehler: eine Wortliste mit 200.000 Zeilen gegen einen Knoten zu starten, dessen Versuchserlaubnis bei 120 endet.
