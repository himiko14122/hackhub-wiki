...
Für einen tieferen Einblick, wie diese Werkzeuge mit Verteidigungssoftware interagieren, siehe unsere [HackHub-Exploit-Framework-Übersicht](/en/network-hacking/), die jedes Werkzeug seiner Verteidigungs-Gegenmaßnahme zuordnet.
